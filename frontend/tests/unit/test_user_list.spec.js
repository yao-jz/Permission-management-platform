...
test('test_open_child_components', async () => {
    await wrapper.componentVM.add_user_dialog()
    await wrapper.vm.$nextTick()
    expect(wrapper.vm.selected_key).toBe("")
    expect(wrapper.vm.selected_user).toBe("")
    ...
    expect(wrapper.vm.selected_user).toBe("name")
    expect(wrapper.vm.add_dialog_visible).toBe(true)
    
    await wrapper.componentVM.user_role({
        name: "name",
        key: "key"
    })
    await wrapper.vm.$nextTick()
    expect(wrapper.vm.selected_key).toBe("key")
    expect(wrapper.vm.selected_user).toBe("name")
    expect(wrapper.vm.modify_dialog_visible).toBe(true)
})
...
test('test_close_child_components', async () => {
    ...
    await wrapper.componentVM.close_modify()
    await wrapper.vm.$nextTick()
    expect(wrapper.vm.selected_key).toBe("")
    expect(wrapper.vm.selected_user).toBe("")
    expect(wrapper.vm.modify_dialog_visible).toBe(false)
})
